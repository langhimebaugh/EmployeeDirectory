...
public class SearchableActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    private class SearchTask extends AsyncTask<String, Void, Cursor> {
        ...
        protected void onPostExecute(Cursor cursor) {
            ...
            android.support.v4.widget.SimpleCursorAdapter adapter = new android.support.v4.widget.SimpleCursorAdapter(getBaseContext(), R.layout.list_item, cursor, dataColumns, viewIDs, 0);
